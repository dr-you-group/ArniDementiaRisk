...
2. Create an empty folder or new RStudio project, and in `R`, use the following code to install the study package and its dependencies:
    ...
    download.file("https://raw.githubusercontent.com/ohdsi-studies/arniv1t2/main/renv.lock", "renv.lock")
    renv::init()
    ```  
...
License
=======
The arniv1t2 package is licensed under Apache License 2.0

Development
===========
arniv1t2 was developed in ATLAS and R Studio.
