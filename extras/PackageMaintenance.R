...
OhdsiRTools::checkUsagePackage("ARNIrevised240726")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/ARNIrevised240726.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ARNIrevised240726.pdf")
...
OhdsiRTools::createRenvLockFile("ARNIrevised240726")
